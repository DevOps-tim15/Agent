...
APP_NAME_AGENT_PRODUCTS=product-service
APP_NAME_AGENT_SHOPPING=shopping-service
APP_NAME_AGENT_REPORT=report-service
APP_NAME_AGENT_GATEWAY=gateway-agent
